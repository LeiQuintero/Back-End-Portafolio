...
import com.mipotafolio.PortafolioLeidy.Dto.dtoEducacion;
...
import com.mipotafolio.PortafolioLeidy.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        //si pasa estas validaciones entonces--
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE()
            ); //Le paso por parámetro nombre y descripción del registro de educacion y luego uso el método del service save
